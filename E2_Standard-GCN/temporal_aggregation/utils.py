...
def val_model(best_result_by_split, typeOfGraph, params, folders, norm, device, path_A, way_to_build_graph, T):
    """
    ...
    for folder in range(len(folders)):
        ...
        for t in range(T):
            ...
            A = pd.read_csv(f"../dtw_matrices/{folders[folder]}/tr_{norm}_TS_{t}_sparse.csv")
